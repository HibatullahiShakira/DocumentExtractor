...
FILE_2_RAW = {
    ...
    "positions": [
        ...
        },
        {
            ...
            "r": "",
            "antrieb": "Elektro",
            "bemerkung": "Deita Rolladenkasten 180 mm hoch",
            "stueck": 1,
        },
        {
            "pos": "DG2",
            ...
            "r": "R",
            "antrieb": "Elektro",
            "bemerkung": "Delta Rolladenkasten 180 mm hoch",
            "stueck": 1,
        },
        {
            "pos": "DG3",
...
if __name__ == "__main__":
    ...
    tests = [
        v for k, v in sorted(globals().items()) if k.startswith("test_") and inspect.isfunction(v)
    ]
    passed = failed = 0
    for test in tests:
        try:
